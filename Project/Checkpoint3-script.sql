...
CREATE TABLE ItemAgeRating (
    ...
    FOREIGN KEY (ItemID) REFERENCES Item(ItemID),
    FOREIGN KEY (AgeRatingID) REFERENCES AgeRating(AgeRatingID),
    UNIQUE (ItemID, AgeRatingID) -- Ensure each Item-AgeRatingID combination is unique
);
...
VALUES
    (1, 2), -- The Legend of Zelda: Breath of the Wild by Nintendo
    (2, 4), -- God of War by Santa Monica Studio
    (3, 3), -- Red Dead Redemption 2 by Rockstar Games
    (4, 1), -- Fortnite by Epic Games
    (5, 2), -- Cyberpunk 2077 by CD Projekt Red
    (6, 2), -- Elden Ring by FromSoftware
    (7, 1), -- Among Us by Innersloth
    (8, 2), -- Genshin Impact by miHoYo
    (9, 2), -- Hollow Knight by Team Cherry
    (10, 2), -- Minecraft Dungeons by Mojang Studios
    (11, 1), -- Crazy in Love by Beyoncé
    (12, 1), -- Fancy by Iggy Azalea
    (13, 1), -- Uptown Funk by Mark Ronson
    (14, 1), -- Lose You to Love Me by Selena Gomez
    (15, 1), -- Harry Potter and the Sorcerers Stone by J.K. Rowling
    (16, 1), -- The Lightning Thief by Rick Riordan
    (17, 2), -- Spider-Man: Homecoming by Stan Lee
    (18, 2), -- Batman: Year One by Frank Miller
    (19, 2), -- X-Men: Days of Future Past by Chris Claremont
    (20, 2), -- Justice League: Origin by Geoff Johns
    (21, 1),
    (22, 1),
    (23, 1),
    (24, 1),
